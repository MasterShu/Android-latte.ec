package club.mastershu.latte.ui;
...
import club.mastershu.latte.util.DimenUitl;
...
public class LatteLoader {
    ...
    public static void showLoading(Context context, String type) {
        ...
        int devicewidth = DimenUitl.getScreenWidth();
        int deviceheight = DimenUitl.getScreenHeight();
